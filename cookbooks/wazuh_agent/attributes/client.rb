...
default['ossec']['conf']['client']['enrollment']['manager_address'] = ""
default['ossec']['conf']['client']['enrollment']['port'] = 1515
default['ossec']['conf']['client']['enrollment']['agent_name'] = ""
default['ossec']['conf']['client']['enrollment']['groups'] = ""
default['ossec']['conf']['client']['enrollment']['agent_address'] = ""
default['ossec']['conf']['client']['enrollment']['ssl_cipher'] = "HIGH:!ADH:!EXP:!MD5:!RC4:!3DES:!CAMELLIA:@STRENGTH"
default['ossec']['conf']['client']['enrollment']['server_ca_path'] = ""
default['ossec']['conf']['client']['enrollment']['agent_certificate_path'] = "" 
default['ossec']['conf']['client']['enrollment']['agent_key_path'] = ""
default['ossec']['conf']['client']['enrollment']['authorization_pass_path'] = ""
