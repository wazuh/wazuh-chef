...
default['ossec']['conf']['rootcheck']['rootkit_files'] = "#{node['ossec']['dir']}/var/shared/rootkit_files.txt"
default['ossec']['conf']['rootcheck']['rootkit_trojans'] = "#{node['ossec']['dir']}/var/shared/rootkit_trojans.txt"
